...
SELECT language FROM countrylanguages WHERE countrycode = 'SMR';
...
SELECT name FROM cities WHERE population = 91000;
SELECT * FROM cities WHERE name = 'Najran';
SELECT * FROM cities WHERE name = 'Krasnogorsk';
-- Najran, Saudi Arabia